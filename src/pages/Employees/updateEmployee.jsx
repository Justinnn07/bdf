...
const updateEmployee = (props) => {
    ...
    useEffect(() => {
        instance.get(`${process.env.REACT_APP_API_URL}/admin/employee/${id}`)
            .then((res) => {
    ...
    const onSubmit = (data, e) => {
        // data.branch_id = id
        instance.patch(`${process.env.REACT_APP_API_URL}/admin/employee/${id}`, data)
            .then((res) => {
                setIsSuccess(true)
            })
            .catch((err) => {
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                ...
                <Container fluid>
                    <Breadcrumbs title="Dashboard" breadcrumbItem="Edit Employees" />
